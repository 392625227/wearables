;;This C file has code to take 6000 data samples from pulse sensor and use ADS1115 to convert it into analog form using I2C protocol and to store the analog values in a xls file. 
